...
public class Electryte extends Item {
    ...
    public Electryte(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull InteractionResult use(@NotNull Level level, @NotNull Player player, @NotNull InteractionHand hand) {
        ...
        player.addEffect(new MobEffectInstance(MobEffects.SPEED, 30 * 20, 2));
    ...
    private void applyZapAndDamageToEntities(Level world, Entity user, double radius) {
        ...
        for (Entity entity : nearbyEntities) {
            if (entity instanceof LivingEntity livingEntity) {
                ...
                livingEntity.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 140, 40, false, false));
